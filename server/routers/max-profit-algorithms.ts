      ...
      return {
        strategy: {
          ...
          allocation: [
            {
              ...
              percentage: 40,
              apy: 18,
              expectedYield: input.investmentAmount * 0.4 * 0.18,
            },
            {
          ...
          monthlyProjection: [
            ...
            { month: 3, value: input.investmentAmount * 1.11 },
  ...
  activateMaxProfitMode: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return {
        ...
        status: "active",
        message:
          "Max Profit Mode activated. AI is now optimizing your portfolio for maximum returns.",
