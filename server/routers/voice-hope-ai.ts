...
export const voiceHopeAiRouter = router({
  ...
  talkToHope: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return {
        ...
        hopeResponse:
          "Hey! I just analyzed the market and I'm seeing a strong buy signal on SKYCOIN4444. The price is at 10.52 and I think we could see 12.80 within 48 hours. Want me to execute a trade?",
  ...
  getHopeDailyBriefing: protectedProcedure.query(async ({ ctx }) => {
    return {
      briefing: {
        greeting:
          "Good morning! I'm Hope, your AI trading companion. Here's your daily briefing.",
        marketOverview:
          "The crypto market is showing strong bullish signals today. Bitcoin is up 2.5% and Ethereum is up 3.2%.",
        topOpportunities: [
  ...
  askHopeForAdvice: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return {
        ...
        hopeAdvice:
          "That's a great question! Based on current market conditions and your portfolio, I recommend a balanced approach. Consider allocating 40% to SKYCOIN4444, 35% to SHADOW_COIN, and 25% to staking. This should give you a good mix of growth and stability.",
        confidence: 0.92,
        reasoning: [
  ...
  getHopeRealTimeCommentary: protectedProcedure.query(async ({ ctx }) => {
    return {
      commentary: {
        ...
        marketAnalysis:
          "SKYCOIN4444 just broke through the 10.50 resistance level. This is a bullish signal!",
        tradeOpportunity:
          "I'm seeing a potential scalp trade on the 5-minute chart. Should I execute?",
        riskAlert:
          "Volume is dropping on SHADOW_COIN. I'm reducing exposure to manage risk.",
        sentiment: "bullish",
        audioResponse: "base64_encoded_audio_data",
      },
    };
