  ...
  getStatus: protectedProcedure.query(async ({ ctx }) => {
    return {
      manus: {
        ...
        message:
          "Manus Mode is active. I am autonomously managing your portfolio, social presence, and market opportunities.",
        capabilities: [
  ...
  configureAutonomy: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return {
        ...
        settings: input,
        message:
          "Manus Mode autonomy settings updated. System is re-calibrating.",
      };
    }),
      ...
      insights: [
        {
          ...
          description:
            "Detected 2.4% price discrepancy across liquidity pools.",
