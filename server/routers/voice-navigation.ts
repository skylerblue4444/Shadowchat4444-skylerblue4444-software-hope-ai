    ...
    return {
      commands: [
          ...
          commands: [
            {
              ...
              example: "Buy 100 SKYCOIN4444",
              action: "execute_trade",
            },
            {
              command: "Sell [amount] [token]",
              example: "Sell 50 SHADOW_COIN",
              action: "execute_trade",
            },
            {
              command: "Show portfolio",
              example: "Show portfolio",
              action: "view_portfolio",
            },
            {
              command: "What is the price of [token]",
              example: "What is the price of Bitcoin",
              action: "get_price",
            },
            {
              command: "Enable max profit mode",
              example: "Enable max profit mode",
        ...
        },
        {
          ...
          commands: [
            {
              command: "Hope, what do you recommend",
              example: "Hope, what do you recommend",
              action: "ask_hope",
            },
            {
              command: "Hope, enable hunhidge mode",
              example: "Hope, enable hunhidge mode",
              action: "enable_hunhidge",
            },
            {
              command: "Hope, show my stats",
              example: "Hope, show my stats",
              action: "get_stats",
            },
          ],
        },
        {
          ...
          commands: [
            {
              command: "Manus, take over",
              example: "Manus, take over",
              action: "activate_manus",
            },
            {
              command: "Manus, optimize portfolio",
              example: "Manus, optimize portfolio",
              action: "optimize",
            },
            {
              command: "Manus, what opportunities do you see",
              example: "Manus, what opportunities do you see",
