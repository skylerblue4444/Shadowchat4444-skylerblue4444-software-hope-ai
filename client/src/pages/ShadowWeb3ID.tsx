...
export default function ShadowWeb3ID() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Decentralized Web3 identity with ENS, DID, and cross-chain reputation</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Own Your Identity</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-violet-400">847K</p><p className="text-xs text-muted-foreground">Identities</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">8.4M</p><p className="text-xs text-muted-foreground">Credentials</p></CardContent></Card>
