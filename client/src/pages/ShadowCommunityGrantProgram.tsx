...
export default function ShadowCommunityGrantProgram() {
  ...
  const items=[{icon:"💰",title:"Up to $50K",desc:"Grants up to $50,000 in SKY4444",badge:"Generous"},
    {icon:"📝",title:"Apply",desc:"Open application process",badge:"Accessible"},
    {icon:"🏛️",title:"DAO Vote",desc:"Community votes on grants",badge:"Democratic"},
    {icon:"📊",title:"Milestone",desc:"Milestone-based disbursement",badge:"Accountable"},
    {icon:"🌍",title:"Global",desc:"Open to developers worldwide",badge:"Inclusive"},
    {icon:"✦",title:"SKY4444",desc:"All grants in SKY4444",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Developer Grants</h1>
        <p className="text-xs text-muted-foreground">Fund your crypto project · SKY4444 grants · Open applications</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Fund your crypto vision.</p>
