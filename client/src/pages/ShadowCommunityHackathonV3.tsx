...
export default function ShadowCommunityHackathonV3() {
  ...
  const items=[{icon:"🏆",title:"$100K",desc:"$100K in total prizes",badge:"Substantial"},
    {icon:"⏰",title:"48 Hours",desc:"48-hour hackathon format",badge:"Intense"},
    ...
    {icon:"👨‍⚖️",title:"Judges",desc:"Expert panel of judges",badge:"Fair"},
    {icon:"✦",title:"SKY4444",desc:"Win SKY4444 prizes",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Hackathon V3</h1>
        <p className="text-xs text-muted-foreground">Build on SKY4444 · $100K prizes · 48 hours · Global</p>
      </div>
