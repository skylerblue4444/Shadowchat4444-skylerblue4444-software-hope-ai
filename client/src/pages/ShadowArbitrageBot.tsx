...
export default function ShadowArbitrageBot() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Automated cross-exchange arbitrage bot — finds and executes price differences instantly</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Arbitrage</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-cyan-400">50+</p><p className="text-xs text-muted-foreground">Exchanges</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">0.3-2pct</p><p className="text-xs text-muted-foreground">Avg Profit</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">Under 50ms</p><p className="text-xs text-muted-foreground">Speed</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">Yes</p><p className="text-xs text-muted-foreground">Auto</p></CardContent></Card>
      </div>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">Arbitrage Bot</p>
