...
export default function ShadowPlatformV4SmartAlerts() {
  ...
  const items=[{icon:"🤖",title:"AI Filter",desc:"AI filters out noise",badge:"Smart"},
    {icon:"🎯",title:"Precision",desc:"Only alerts that matter",badge:"Relevant"},
    {icon:"📊",title:"Multi-Source",desc:"Alerts from all data sources",badge:"Complete"},
    {icon:"⚡",title:"Instant",desc:"Alerts in under 1 second",badge:"Fast"},
    {icon:"📱",title:"Multi-Channel",desc:"App email SMS Telegram",badge:"Everywhere"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">AI-powered alerts · No noise · Only what matters</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Never miss what matters. Never be spammed.</p>
