...
export default function ShadowSecurityCenter() {
  const items = [
    { icon: "🔐", title: "End-to-End", desc: "All messages encrypted", badge: "Private" },
          { icon: "🛡️", title: "2FA", desc: "TOTP · SMS · Hardware key", badge: "Secure" },
          { icon: "🔍", title: "Bug Bounty", desc: "Report bugs · Earn SKY4444", badge: "Community" },
          { icon: "🚫", title: "Zero Trust", desc: "Verify everything · Trust nothing", badge: "Modern" },
          { icon: "📋", title: "SOC 2", desc: "Type II compliance", badge: "Enterprise" },
          { icon: "🔑", title: "Key Management", desc: "HSM-backed key storage", badge: "Military-grade" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Security Center</h1>
        <p className="text-xs text-muted-foreground">Zero-trust · E2E encryption · 2FA · Bug bounty</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Your security is our obsession. Zero compromises.</p>
