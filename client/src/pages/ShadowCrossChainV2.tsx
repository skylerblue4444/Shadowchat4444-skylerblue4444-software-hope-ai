...
export default function ShadowCrossChainV2() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Advanced cross-chain bridge with AI routing, MEV protection, and 47-chain support</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Cross-Chain Bridge V2</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">847M USD</p><p className="text-xs text-muted-foreground">Bridge Volume/Day</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">Under 0.1pct</p><p className="text-xs text-muted-foreground">Avg Fee</p></CardContent></Card>
      </div>
