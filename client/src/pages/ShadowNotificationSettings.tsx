...
export default function ShadowNotificationSettings() {
  const items = [
    { icon: "📧", title: "Email", desc: "Control email frequency", badge: "Manage" },
    { icon: "📱", title: "Push", desc: "Mobile push notifications", badge: "Instant" },
    { icon: "💬", title: "SMS", desc: "Text message alerts", badge: "Direct" },
    { icon: "🔔", title: "In-App", desc: "In-platform notifications", badge: "Native" },
    { icon: "⚙️", title: "Frequency", desc: "Instant daily weekly digest", badge: "Control" },
    { icon: "✦", title: "SKY4444", desc: "SKY4444 mining alerts", badge: "Priority" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Notification Settings</h1>
        <p className="text-xs text-muted-foreground">Customize every alert · Email SMS push · Frequency</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Get the right alerts at the right time.</p>
