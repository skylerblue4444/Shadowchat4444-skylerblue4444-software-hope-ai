...
import { Shield, Lock, Eye, EyeOff, Package, CheckCircle, AlertTriangle } from "lucide-react";

const LISTINGS = [
  { id: 1, title: "Digital Privacy Suite", price: "0.044 SKY4444", category: "Software", escrow: true, verified: true },
  { id: 2, title: "Encrypted VPN Bundle (1yr)", price: "0.444 SKY4444", category: "Privacy", escrow: true, verified: true },
  { id: 3, title: "Secure Email Service (Lifetime)", price: "0.084 SKY4444", category: "Privacy", escrow: true, verified: true },
  { id: 4, title: "Hardware Security Key", price: "0.844 SKY4444", category: "Hardware", escrow: true, verified: true },
  { id: 5, title: "Anonymous SIM Card", price: "0.244 SKY4444", category: "Telecom", escrow: true, verified: true },
  { id: 6, title: "Burner Device Setup Guide", price: "0.044 SKY4444", category: "Guide", escrow: true, verified: true },
];
...
export default function ShadowDarkWebMarket() {
  ...
  const handlePurchase = (id: number, title: string, price: string) => {
    ...
    setTimeout(() => {
      ...
      toast.success(`Escrow released. "${title}" delivered. Transaction complete.`);
    }, 4000);
  };
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-black text-violet-400">Dark Web Marketplace</h1>
        ...
        <Card className="border-violet-500/40 bg-gradient-to-br from-violet-900/20 to-slate-900/20">
          <CardContent className="py-6 px-4 space-y-4">
            ...
            <p className="text-center text-sm font-bold">Enter Access Key to Decrypt Marketplace</p>
            <p className="text-center text-xs text-muted-foreground">
              All transactions protected by SKY4444 escrow. Seller only releases funds on confirmed delivery.
            </p>
        ...
        <Card className="border-border/50 bg-muted/20">
          <CardContent className="py-3 px-4 flex items-start gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              This marketplace is a private, encrypted platform for legal digital goods and privacy tools only.
              All listings are verified. All transactions use SKY4444 escrow — funds only release on confirmed delivery.
              Operated by Skyler Blue IT Resolutions.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Card className="border-border/50 text-center">
          <CardContent className="py-3 px-2">
            <p className="font-black text-sm text-violet-400">{LISTINGS.length}</p>
            ...
            <CardContent className="py-3 px-4">
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-start gap-2 flex-1">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      <Badge variant="outline" className="text-xs py-0 px-1">{item.category}</Badge>
                      {item.escrow && (
                ...
                <div className="text-right shrink-0">
                  <p className="text-sm font-black text-yellow-400">{item.price}</p>
                  <Button
                    size="sm"
      ...
      <Card className="border-border/50 bg-muted/20">
        <CardContent className="py-3 px-4 flex items-start gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            All purchases use SKY4444 escrow. Funds are held until delivery is confirmed. 
            Operated exclusively by Skyler Blue IT Resolutions — only Skyler receives order information.
          </p>
        </CardContent>
      </Card>
