...
export default function ShadowGameCryptoFarm() {
  ...
  const items=[{icon:"🌾",title:"Farm Land",desc:"Buy and upgrade farm plots",badge:"Own"},
    {icon:"⛏️",title:"Mine Crops",desc:"Crops mine SKY4444",badge:"Earn"},
    {icon:"🏗️",title:"Build",desc:"Build farm infrastructure",badge:"Develop"},
    {icon:"🤝",title:"Trade",desc:"Trade crops with other farmers",badge:"Social"},
    {icon:"🏆",title:"Compete",desc:"Biggest farm wins prizes",badge:"Compete"},
    {icon:"✦",title:"SKY4444",desc:"Farm earns real SKY4444",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Crypto Farm</h1>
        <p className="text-xs text-muted-foreground">Idle farming game · Grow your crypto farm · Earn SKY4444</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">The crypto idle game that pays real money.</p>
