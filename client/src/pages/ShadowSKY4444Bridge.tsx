...
export default function ShadowSKY4444Bridge() {
  const items = [
    { icon: "🌉", title: "ETH Bridge", desc: "SKY4444 on Ethereum", badge: "ERC-20" },
    { icon: "☀️", title: "SOL Bridge", desc: "SKY4444 on Solana", badge: "SPL" },
    { icon: "🟡", title: "BNB Bridge", desc: "SKY4444 on BNB Chain", badge: "BEP-20" },
    { icon: "🟣", title: "Polygon", desc: "SKY4444 on Polygon", badge: "L2" },
    { icon: "🔺", title: "Avalanche", desc: "SKY4444 on Avalanche", badge: "C-Chain" },
    { icon: "✦", title: "Native", desc: "SKY4444 everywhere", badge: "Omnichain" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">SKY4444 Bridge</h1>
        <p className="text-xs text-muted-foreground">Bridge SKY4444 to Ethereum Solana BNB Polygon Avalanche</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">SKY4444 on every major chain.</p>
