...
export default function ShadowUSDTCoinHub() {
  ...
  const items=[{icon:"💵",title:"USDT",desc:"The world's most used stablecoin",badge:"Stable"},
    {icon:"💰",title:"Earn Yield",desc:"Up to 12% APY on USDT",badge:"Earn"},
    {icon:"🌉",title:"Cross-Chain",desc:"USDT on ETH SOL TRX BNB",badge:"Everywhere"},
    {icon:"💳",title:"Payments",desc:"Pay with USDT anywhere",badge:"Spend"},
    {icon:"📊",title:"Track",desc:"USDT balance and history",badge:"Monitor"},
    {icon:"✦",title:"SKY4444",desc:"USDT-SKY4444 pair",badge:"Pair"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">USDT Stablecoin Hub</h1>
        <p className="text-xs text-muted-foreground">Tether USDT · Earn yield · Cross-chain · Payments</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Stable value. Unstable gains.</p>
