...
export default function ShadowCryptoInstitutional() {
  ...
  const items=[{icon:"🏦",title:"Prime Brokerage",desc:"Institutional trading services",badge:"Professional"},
    {icon:"🤝",title:"OTC Desk",desc:"Large block OTC trading",badge:"Private"},
    {icon:"🔐",title:"Custody",desc:"Institutional-grade custody",badge:"Secure"},
    {icon:"📊",title:"Reporting",desc:"Institutional reporting suite",badge:"Compliant"},
    {icon:"⚖️",title:"Compliance",desc:"Full regulatory compliance",badge:"Legal"},
    {icon:"✦",title:"SKY4444",desc:"Institutional SKY4444 services",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Institutional Services</h1>
        <p className="text-xs text-muted-foreground">Prime brokerage · OTC · Custody · Reporting · Compliance</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Institutional-grade crypto services.</p>
