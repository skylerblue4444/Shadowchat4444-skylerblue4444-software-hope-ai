...
export default function ShadowCryptoFlash() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Uncollateralized flash loans for arbitrage, liquidations, and DeFi strategies</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Instant Capital</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-yellow-400">847M USD</p><p className="text-xs text-muted-foreground">Loan Volume</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">12</p><p className="text-xs text-muted-foreground">Protocols</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">0.84pct</p><p className="text-xs text-muted-foreground">Avg Profit</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">1 Block</p><p className="text-xs text-muted-foreground">Speed</p></CardContent></Card>
      </div>
