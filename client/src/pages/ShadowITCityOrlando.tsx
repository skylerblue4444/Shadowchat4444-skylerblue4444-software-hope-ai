...
export default function ShadowITCityOrlando() {
  ...
  const items=[{icon:"📞",title:"Call Now",desc:"479-406-7123 Orlando IT",badge:"Contact"},
    {icon:"💻",title:"Managed IT",desc:"Complete IT management",badge:"Full"},
    {icon:"🛡️",title:"Security",desc:"Cybersecurity for Orlando",badge:"Safe"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">Managed IT services for Orlando Florida businesses</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Orlando's trusted IT partner.</p>
