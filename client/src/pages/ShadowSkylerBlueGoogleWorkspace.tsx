...
import { Shield, Phone, Server, Monitor, TrendingUp, Layers, Building2, Globe, Zap, Map, CheckCircle, AlertTriangle } from "lucide-react";
...
const DATA: Record<string, { icon: string; title: string; desc: string; stats: {label:string;value:string;color:string}[]; features: string[]; accent: string }> = {
  ShadowSkylerBlueFirewall: {
    icon: "🔥", title: "Firewall Management", accent: "text-red-400",
    ...
    features: ["Fortinet/Palo Alto/SonicWall","IDS/IPS","Application control","URL filtering","VPN gateway","Zero-day protection"],
  },
  ShadowSkylerBlueVoIP2: {
    icon: "📞", title: "VoIP Phone Systems", accent: "text-teal-400",
    ...
    features: ["HD voice calls","Auto-attendant","Call recording","Mobile softphone","Conference bridge","CRM integration"],
  },
  ShadowSkylerBlueServer: {
    icon: "🖥️", title: "Server Management", accent: "text-slate-400",
    ...
    features: ["Windows/Linux servers","VMware/Hyper-V","Performance tuning","Capacity planning","Patch management","24/7 monitoring"],
  },
  ShadowSkylerBlueWorkstation: {
    icon: "💻", title: "Workstation Management", accent: "text-purple-400",
    ...
    features: ["Windows/Mac/Linux","Automated deployment","Software management","Security hardening","Remote support","Hardware refresh planning"],
  },
  ShadowCryptoLending2: {
    icon: "🏦", title: "Crypto Lending 2.0", accent: "text-amber-400",
    ...
    features: ["Flash loans","Undercollateralized loans","AI credit scoring","Multi-asset collateral","Auto-liquidation","Credit delegation"],
  },
  ShadowCryptoDeFiAggregator: {
    icon: "🔗", title: "DeFi Aggregator", accent: "text-cyan-400",
    ...
    features: ["Best-rate routing","Gas optimization","Multi-chain","Slippage protection","MEV protection","One-click rebalancing"],
  },
  ShadowSkylerBlueMicrosoftMSP: {
    icon: "🪟", title: "Microsoft 365 MSP", accent: "text-blue-400",
    ...
    features: ["M365 deployment","Exchange Online","Teams setup","SharePoint","Azure AD","Security & compliance"],
  },
  ShadowSkylerBlueGoogleWorkspace: {
    icon: "🔵", title: "Google Workspace MSP", accent: "text-green-400",
    ...
    features: ["Gmail/Drive/Meet","Admin console","Security policies","Data migration","Training","24/7 support"],
  },
  ShadowCryptoYieldAggregator: {
    icon: "🌾", title: "Yield Aggregator Pro", accent: "text-yellow-400",
    ...
    features: ["Auto-compounding","AI strategy selection","Gas optimization","Risk scoring","Multi-chain","Harvest automation"],
  },
  ShadowSkylerBlueITRoadmap: {
    icon: "🗺️", title: "IT Strategic Roadmap", accent: "text-indigo-400",
    ...
    features: ["Technology assessment","3-5 year planning","Budget modeling","Vendor selection","Risk assessment","Quarterly reviews"],
  },
};

export default function ShadowSkylerBlueGoogleWorkspace() {
  const d = DATA["ShadowSkylerBlueGoogleWorkspace"];
  return (
