...
import { Cpu, Bot, HardDrive, Cloud, TrendingUp, BarChart3, Building2, Monitor, ArrowLeftRight, ShieldAlert, CheckCircle, Zap, AlertTriangle } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { toast } from "sonner";

const DATA: Record<string, { icon: string; title: string; desc: string; stats: {label:string;value:string;color:string}[]; features: string[]; accent: string }> = {
  ShadowSkylerBlueIoT: {
    icon: "🔌", title: "IoT Device Management", accent: "text-teal-400",
    ...
    features: ["Device onboarding","Firmware management","Security hardening","Real-time monitoring","Anomaly detection","API integrations"],
  },
  ShadowSkylerBlueAIAssistant: {
    icon: "🤖", title: "AI IT Assistant", accent: "text-violet-400",
    ...
    features: ["Natural language support","Auto ticket creation","Knowledge base search","Escalation to human","Multi-language support","Learning from feedback"],
  },
  ShadowSkylerBlueBackup2: {
    icon: "💾", title: "Cloud Backup Pro", accent: "text-orange-400",
    ...
    features: ["Immutable backups","Ransomware protection","Instant recovery","Offsite replication","Compliance retention","Encryption at rest"],
  },
  ShadowSkylerBlueCloud2: {
    icon: "☁️", title: "Cloud Infrastructure", accent: "text-sky-400",
    ...
    features: ["AWS/Azure/GCP management","Cloud migration","Cost optimization","Auto-scaling","Security hardening","24/7 monitoring"],
  },
  ShadowCryptoOptions: {
    icon: "📈", title: "Crypto Options Trading", accent: "text-emerald-400",
    ...
    features: ["Calls & puts","Covered calls","Cash-secured puts","Iron condors","Delta hedging","Greeks dashboard"],
  },
  ShadowCryptoFutures2: {
    icon: "⚡", title: "Perpetual Futures", accent: "text-yellow-400",
    ...
    features: ["Up to 100x leverage","Cross & isolated margin","Liquidation protection","Advanced order types","Auto-deleveraging","Insurance fund"],
  },
  ShadowSkylerBlueMSP2: {
    icon: "🏢", title: "MSP Enterprise Tier", accent: "text-indigo-400",
    ...
    features: ["Dedicated account team","Custom SLA agreements","On-site engineers","Executive business reviews","Strategic IT roadmap","Budget planning"],
  },
  ShadowSkylerBlueRemote: {
    icon: "🖥️", title: "Remote IT Support", accent: "text-cyan-400",
    ...
    features: ["Instant remote access","Screen sharing","File transfer","Multi-platform support","Session recording","Unattended access"],
  },
  ShadowCryptoArbitrage: {
    icon: "🔄", title: "Crypto Arbitrage Bot", accent: "text-pink-400",
    ...
    features: ["Cross-exchange arbitrage","Flash loan arbitrage","Triangular arbitrage","Gas optimization","Risk management","Real-time execution"],
  },
  ShadowSkylerBluePenetration: {
    icon: "🎯", title: "Penetration Testing", accent: "text-red-400",
    ...
    features: ["Network pen testing","Web app testing","Social engineering","Physical security","Red team exercises","Detailed remediation report"],
  },
};

export default function ShadowSkylerBlueAIAssistant() {
  const d = DATA["ShadowSkylerBlueAIAssistant"];
  return (
