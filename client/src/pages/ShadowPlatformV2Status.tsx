...
export default function ShadowPlatformV2Status() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"🟢",title:"All Systems",desc:"All systems operational",badge:"Good"},
    {icon:"⚡",title:"API",desc:"API response time",badge:"Performance"},
    {icon:"⛏️",title:"Mining",desc:"Mining service status",badge:"Core"},
    {icon:"💰",title:"Trading",desc:"Trading engine status",badge:"Core"},
    {icon:"📊",title:"Analytics",desc:"Analytics service status",badge:"Data"},
    {icon:"📅",title:"History",desc:"90-day uptime history",badge:"Transparent"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">System Status</h1>
        <p className="text-xs text-muted-foreground">Real-time platform health · Uptime · Incidents · History</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">99.9% uptime. Always.</p>
