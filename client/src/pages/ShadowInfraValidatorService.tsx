...
export default function ShadowInfraValidatorService() {
  ...
  const items=[{icon:"⟠",title:"ETH Validator",desc:"Ethereum 2.0 validator",badge:"Earn"},
    {icon:"◎",title:"SOL Validator",desc:"Solana validator service",badge:"Earn"},
    {icon:"🔵",title:"AVAX Validator",desc:"Avalanche validator",badge:"Earn"},
    {icon:"🔴",title:"DOT Validator",desc:"Polkadot validator",badge:"Earn"},
    {icon:"📊",title:"Dashboard",desc:"Validator performance dashboard",badge:"Visible"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 validator rewards",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Validator as a Service</h1>
        <p className="text-xs text-muted-foreground">Stake and validate · Non-custodial · 99.9% uptime · Earn</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Earn validator rewards without the complexity.</p>
