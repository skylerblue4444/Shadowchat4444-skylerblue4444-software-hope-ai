...
export default function ShadowTradingOptions() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Full options trading with Greeks, volatility surface, spreads, and AI strategy builder</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Advanced Options</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">8247</p><p className="text-xs text-muted-foreground">Options Contracts</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">Real-time</p><p className="text-xs text-muted-foreground">Greeks</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">247</p><p className="text-xs text-muted-foreground">AI Strategies</p></CardContent></Card>
      </div>
