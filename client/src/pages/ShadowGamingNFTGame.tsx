...
export default function ShadowGamingNFTGame() {
  ...
  const items=[{icon:"🎮",title:"P2E Games",desc:"Play-to-earn game directory",badge:"Earn"},
    {icon:"🧑",title:"NFT Characters",desc:"Own your game characters",badge:"Own"},
    {icon:"💰",title:"SKY4444 Rewards",desc:"Earn SKY4444 by playing",badge:"Incentive"},
    {icon:"🏆",title:"Tournaments",desc:"Compete for SKY4444 prizes",badge:"Compete"},
    {icon:"🎨",title:"Marketplace",desc:"Trade game NFTs",badge:"Market"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 is the game currency",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">NFT Game Hub</h1>
        <p className="text-xs text-muted-foreground">Play-to-earn games · NFT characters · SKY4444 rewards</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Play games. Earn real crypto.</p>
