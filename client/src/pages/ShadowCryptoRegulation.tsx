...
export default function ShadowCryptoRegulation() {
  const items = [
    { icon: "🇺🇸", title: "USA", desc: "SEC CFTC IRS crypto rules", badge: "Regulatory" },
    { icon: "🇪🇺", title: "EU", desc: "MiCA regulation updates", badge: "Compliant" },
    { icon: "🇨🇳", title: "China", desc: "China crypto policy", badge: "Restricted" },
    { icon: "🇯🇵", title: "Japan", desc: "FSA crypto framework", badge: "Licensed" },
    { icon: "🌍", title: "Global", desc: "50+ country tracker", badge: "Worldwide" },
    { icon: "✦", title: "SKY4444", desc: "SKY4444 regulatory status", badge: "Transparent" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Crypto Regulation Tracker</h1>
        <p className="text-xs text-muted-foreground">Global crypto laws · Country by country · Compliance alerts</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Stay ahead of crypto regulation.</p>
