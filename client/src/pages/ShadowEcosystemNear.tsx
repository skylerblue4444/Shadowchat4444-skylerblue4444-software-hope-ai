...
export default function ShadowEcosystemNear() {
  ...
  const items=[{icon:"⚡",title:"Fast",desc:"Sub-second finality",badge:"Speed"},
    {icon:"💰",title:"Cheap",desc:"Near-zero transaction fees",badge:"Value"},
    {icon:"🔵",title:"Aurora",desc:"EVM-compatible layer",badge:"Compatible"},
    {icon:"🌊",title:"Sharding",desc:"Nightshade sharding",badge:"Scale"},
    {icon:"💰",title:"Trade NEAR",desc:"NEAR trading pairs",badge:"Trade"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">NEAR sharding · Fast cheap · Aurora EVM · Growing DeFi</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">The blockchain built for mass adoption.</p>
