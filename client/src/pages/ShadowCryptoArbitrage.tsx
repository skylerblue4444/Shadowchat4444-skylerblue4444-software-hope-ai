    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">AI-powered arbitrage bot that finds and executes cross-exchange price differences</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Auto Arbitrage</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">247</p><p className="text-xs text-muted-foreground">Exchanges Monitored</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">0.47pct</p><p className="text-xs text-muted-foreground">Avg Profit/Trade</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">Under 10ms</p><p className="text-xs text-muted-foreground">Execution Speed</p></CardContent></Card>
      </div>
