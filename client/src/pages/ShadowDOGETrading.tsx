...
export default function ShadowDOGETrading() {
  const items = [
    { icon: "🐕", title: "DOGE/USDT", desc: "Main DOGE trading pair", badge: "Primary" },
    { icon: "✦", title: "DOGE/SKY4444", desc: "DOGE vs SKY4444 pair", badge: "Unique" },
    ...
    { icon: "🚀", title: "To The Moon", desc: "DOGE community strong", badge: "Community" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">DOGE Trading</h1>
        <p className="text-xs text-muted-foreground">Buy sell Dogecoin · Charts · DOGE/SKY4444 pair · Low fees</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Trade DOGE with the best tools.</p>
