...
export default function ShadowRoadmap() {
  const items = [
    { icon: "Q1 2025", title: "Mobile App", desc: "iOS + Android native apps", badge: "🔜" },
          { icon: "Q1 2025", title: "Exchange Listing", desc: "SKY4444 on major exchanges", badge: "🔜" },
          { icon: "Q2 2025", title: "Visa Card", desc: "Physical SKY4444 card", badge: "🔜" },
          { icon: "Q2 2025", title: "DAO Launch", desc: "Community governance", badge: "🔜" },
          { icon: "Q3 2025", title: "Series A", desc: "$5M funding round", badge: "🔜" },
          { icon: "Q4 2025", title: "1M Users", desc: "Global expansion", badge: "🎯" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Product Roadmap</h1>
        <p className="text-xs text-muted-foreground">What's coming · Q1-Q4 2025 · Community votes</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Vote on features. Shape the future of ShadowChat.</p>
