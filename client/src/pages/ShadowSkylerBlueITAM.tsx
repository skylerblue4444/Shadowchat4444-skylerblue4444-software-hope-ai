...
export default function ShadowSkylerBlueITAM() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">IT asset management with lifecycle tracking, software licensing, and compliance</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">ITAM</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-cyan-400">8.4M</p><p className="text-xs text-muted-foreground">Assets Tracked</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">99.9pct</p><p className="text-xs text-muted-foreground">License Compliance</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">Full</p><p className="text-xs text-muted-foreground">Lifecycle</p></CardContent></Card>
