...
export default function ShadowCryptoBorrowing() {
  const items = [
    { icon: "💳", title: "Borrow USD", desc: "Use crypto as collateral", badge: "Liquid" },
    { icon: "₿", title: "Keep BTC", desc: "Borrow without selling", badge: "Smart" },
    { icon: "⚡", title: "Instant", desc: "Funds in under 1 minute", badge: "Fast" },
    { icon: "💰", title: "Low Rate", desc: "From 4.44% APR", badge: "Cheap" },
    { icon: "📊", title: "LTV", desc: "Up to 70% loan-to-value", badge: "Generous" },
    { icon: "✦", title: "SKY4444", desc: "Extra collateral bonus", badge: "Perk" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Crypto Borrowing</h1>
        <p className="text-xs text-muted-foreground">Borrow against your crypto · No credit check · Instant</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Get cash without selling your crypto.</p>
