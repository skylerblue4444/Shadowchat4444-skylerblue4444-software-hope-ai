...
export default function ShadowFintechCryptoMortgage() {
  ...
  const items=[{icon:"🏠",title:"Buy Home",desc:"Use crypto for down payment",badge:"Possible"},
    {icon:"💰",title:"Crypto Down",desc:"BTC ETH SKY4444 accepted",badge:"Flexible"},
    {icon:"📊",title:"Low Rate",desc:"Competitive mortgage rates",badge:"Affordable"},
    {icon:"🔐",title:"Self-Custody",desc:"Keep remaining crypto",badge:"Control"},
    {icon:"🌍",title:"USA",desc:"Available across the USA",badge:"Wide"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 mortgage discount",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Crypto Mortgage</h1>
        <p className="text-xs text-muted-foreground">Buy real estate with crypto · BTC ETH SKY4444 accepted</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Your crypto can buy you a home.</p>
