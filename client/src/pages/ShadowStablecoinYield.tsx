...
export default function ShadowStablecoinYield() {
  const items = [
    { icon: "💵", title: "USDT Yield", desc: "8% APY on Tether", badge: "Stable" },
    { icon: "🔵", title: "USDC Yield", desc: "9% APY on USDC", badge: "Safe" },
    { icon: "🌈", title: "DAI Yield", desc: "10% APY on DAI", badge: "DeFi" },
    { icon: "📊", title: "Auto-Compound", desc: "Earnings compound daily", badge: "Grow" },
    { icon: "🛡️", title: "Audited", desc: "Security-audited protocols", badge: "Safe" },
    { icon: "✦", title: "SKY4444", desc: "Extra SKY4444 bonus yield", badge: "Bonus" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Stablecoin Yield</h1>
        <p className="text-xs text-muted-foreground">Earn 8-15% APY on USDT USDC DAI · Safe and stable</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Stable returns on stable coins.</p>
