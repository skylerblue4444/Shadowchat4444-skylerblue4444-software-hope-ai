    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">AI-powered risk assessment for portfolios, DeFi positions, and smart contract audits</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Risk Aware</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-red-400">8.4M</p><p className="text-xs text-muted-foreground">Risk Checks/Day</p></CardContent></Card>
