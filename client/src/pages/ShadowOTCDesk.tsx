...
export default function ShadowOTCDesk() {
  const items = [
    { icon: "💰", title: "Min Trade", desc: "$10,000 minimum", badge: "Institutional" },
          { icon: "⚡", title: "Instant Fill", desc: "No slippage · Best price", badge: "Pro" },
          { icon: "🔒", title: "Escrow", desc: "SKY4444 escrow protection", badge: "Safe" },
          { icon: "📞", title: "Dedicated Desk", desc: "479-406-7123 · 24/7", badge: "Personal" },
          { icon: "🌍", title: "Global", desc: "USD · CNY · EUR · Crypto", badge: "Multi-currency" },
          { icon: "📊", title: "Price Discovery", desc: "Real-time OTC rates", badge: "Transparent" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">OTC Trading Desk</h1>
        <p className="text-xs text-muted-foreground">Large trades · No slippage · Direct settlement · SKY4444</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Trade large amounts without moving the market.</p>
