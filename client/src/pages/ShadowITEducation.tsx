...
export default function ShadowITEducation() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">FERPA-compliant IT solutions for K-12 schools, universities, and online learning platforms</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">FERPA Compliant</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-yellow-400">247</p><p className="text-xs text-muted-foreground">Institutions</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">847K</p><p className="text-xs text-muted-foreground">Students Served</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">100pct</p><p className="text-xs text-muted-foreground">FERPA Score</p></CardContent></Card>
