...
export default function ShadowLifestyleShopping() {
  const [active, setActive] = useState(false);
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-black">Crypto Shopping</h1>
          <p className="text-sm text-muted-foreground">Earn SKY4444 cashback at 84K+ online and physical stores worldwide</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Shop and Earn</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-pink-400">84K</p><p className="text-xs text-muted-foreground">Partner Stores</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">Up to 47pct</p><p className="text-xs text-muted-foreground">SKY4444 Cashback</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">847K</p><p className="text-xs text-muted-foreground">Orders/Day</p></CardContent></Card>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">Crypto Shopping — Activate Now</p>
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            onClick={() => { setActive(true); toast.success("Crypto Shopping activated!"); }}
          >
            <Zap className="h-4 w-4 mr-2" />{active ? "Active" : "Activate"}
          </Button>
          <Button variant="outline" onClick={() => toast.info("Opening Crypto Shopping docs...")}>
