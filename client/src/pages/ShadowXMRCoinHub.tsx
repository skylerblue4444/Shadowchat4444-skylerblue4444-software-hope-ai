...
export default function ShadowXMRCoinHub() {
  ...
  const items=[{icon:"🔐",title:"Privacy",desc:"Untraceable transactions",badge:"Private"},
    {icon:"⛏️",title:"Mine XMR",desc:"CPU mining for XMR",badge:"Earn"},
    {icon:"💰",title:"Trade XMR",desc:"XMR/USDT XMR/BTC pairs",badge:"Trade"},
    {icon:"👛",title:"XMR Wallet",desc:"Dedicated Monero wallet",badge:"Hold"},
    {icon:"📊",title:"XMR Chart",desc:"Live XMR price chart",badge:"Track"},
    {icon:"✦",title:"SKY4444",desc:"XMR-SKY4444 trading pair",badge:"Pair"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Monero (XMR) Hub</h1>
        <p className="text-xs text-muted-foreground">Privacy coin · Mine XMR · Untraceable transactions</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">True financial privacy with Monero.</p>
