...
export default function ShadowGlobalMarketTurkey() {
  ...
  const items=[{icon:"🇹🇷",title:"TRY Trading",desc:"Trade in Turkish Lira",badge:"Local"},
    {icon:"📈",title:"Inflation Hedge",desc:"Crypto vs 70% inflation",badge:"Need"},
    {icon:"📊",title:"BtcTurk",desc:"Turkey's largest exchange",badge:"Reference"},
    {icon:"🌍",title:"Bridge",desc:"Between Europe and Asia",badge:"Strategic"},
    {icon:"💰",title:"High Adoption",desc:"Top 5 global crypto adoption",badge:"Active"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">TRY trading · Inflation hedge · BtcTurk · Growing adoption</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Crypto as a shield against inflation.</p>
