...
export default function ShadowCryptoAngelsV2() {
  ...
  const items=[{icon:"👼",title:"Angel Invest",desc:"Angel investing in crypto",badge:"Early"},
    {icon:"🤝",title:"Syndicate",desc:"Join investment syndicates",badge:"Together"},
    {icon:"📋",title:"Deal Room",desc:"Private deal room access",badge:"Exclusive"},
    {icon:"💰",title:"Small Checks",desc:"Invest as little as $1K",badge:"Accessible"},
    {icon:"📊",title:"Portfolio",desc:"Track angel portfolio",badge:"Manage"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 angel deals",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Crypto Angel Network V2</h1>
        <p className="text-xs text-muted-foreground">Connect angels with founders · SKY4444 deals · Syndicate</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Angel investing made simple.</p>
