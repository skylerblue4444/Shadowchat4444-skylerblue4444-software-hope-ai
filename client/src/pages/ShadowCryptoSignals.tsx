...
export default function ShadowCryptoSignals() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">AI-powered crypto trading signals with 84pct accuracy and real-time delivery</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Crypto Signals</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-violet-400">8247</p><p className="text-xs text-muted-foreground">Signals/Day</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">Real-time</p><p className="text-xs text-muted-foreground">Delivery</p></CardContent></Card>
