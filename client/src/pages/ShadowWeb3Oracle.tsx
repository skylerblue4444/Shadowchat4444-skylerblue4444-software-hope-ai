...
export default function ShadowWeb3Oracle() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Decentralized price oracle network for accurate, manipulation-resistant on-chain data</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Trust the Data</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">8247</p><p className="text-xs text-muted-foreground">Data Feeds</p></CardContent></Card>
