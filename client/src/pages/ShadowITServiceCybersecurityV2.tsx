...
export default function ShadowITServiceCybersecurityV2() {
  ...
  const items=[{icon:"🛡️",title:"EDR",desc:"Endpoint detection and response",badge:"Advanced"},
    {icon:"📊",title:"SIEM",desc:"Security information management",badge:"Visibility"},
    {icon:"🔍",title:"SOC",desc:"Security operations center",badge:"Expert"},
    {icon:"🎣",title:"Phishing",desc:"Anti-phishing training",badge:"Human"},
    {icon:"🔐",title:"Zero Trust",desc:"Zero trust architecture",badge:"Modern"},
    {icon:"📞",title:"Protect",desc:"479-406-7123 to protect",badge:"Contact"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Cybersecurity V2</h1>
        <p className="text-xs text-muted-foreground">Advanced threat protection · EDR · SIEM · SOC · Arkansas</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Enterprise security for every business.</p>
