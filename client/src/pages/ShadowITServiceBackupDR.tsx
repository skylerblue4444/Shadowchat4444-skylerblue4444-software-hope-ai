...
export default function ShadowITServiceBackupDR() {
  ...
  const items=[{icon:"💾",title:"3-2-1 Backup",desc:"Industry standard backup strategy",badge:"Best Practice"},
    {icon:"☁️",title:"Cloud Backup",desc:"Secure cloud backup",badge:"Offsite"},
    {icon:"⏱️",title:"RTO/RPO",desc:"Define recovery objectives",badge:"Planned"},
    {icon:"🔄",title:"Test Recovery",desc:"Regular recovery testing",badge:"Verified"},
    {icon:"🚨",title:"DR Plan",desc:"Full disaster recovery plan",badge:"Prepared"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">3-2-1 backup strategy · Cloud backup · RTO RPO · Arkansas</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Never lose your business data.</p>
