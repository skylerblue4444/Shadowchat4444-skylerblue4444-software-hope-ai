...
export default function ShadowITEdge() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Edge computing solutions for IoT, real-time processing, and ultra-low latency applications</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Process at the Edge</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-cyan-400">8247</p><p className="text-xs text-muted-foreground">Edge Nodes</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">84M</p><p className="text-xs text-muted-foreground">IoT Devices</p></CardContent></Card>
