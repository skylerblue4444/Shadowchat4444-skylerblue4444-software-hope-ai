...
export default function ShadowCryptoCBDC() {
  ...
  const items=[{icon:"🏦",title:"CBDC",desc:"Central bank digital currencies",badge:"Official"},
    {icon:"🇨🇳",title:"Digital Yuan",desc:"China e-CNY progress",badge:"Leader"},
    {icon:"🇪🇺",title:"Digital Euro",desc:"EU digital euro status",badge:"Major"},
    {icon:"🇺🇸",title:"Digital Dollar",desc:"US CBDC developments",badge:"Watch"},
    {icon:"📊",title:"Impact",desc:"CBDC impact on crypto",badge:"Analysis"},
    {icon:"✦",title:"SKY4444",desc:"CBDC vs SKY4444",badge:"Compare"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">CBDC Tracker</h1>
        <p className="text-xs text-muted-foreground">Central bank digital currencies · Country by country · Impact</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Track every CBDC in the world.</p>
