...
export default function ShadowPlatformV2Search() {
  ...
  const items=[{icon:"🔍",title:"AI Search",desc:"Understands natural language",badge:"Smart"},
    {icon:"🎤",title:"Voice Search",desc:"Search by speaking",badge:"Hands-free"},
    {icon:"⚡",title:"Instant",desc:"Results in under 100ms",badge:"Fast"},
    {icon:"🌍",title:"Everything",desc:"Search pages coins news users",badge:"Complete"},
    {icon:"📊",title:"Ranked",desc:"Best results ranked first",badge:"Relevant"},
    {icon:"✦",title:"SKY4444",desc:"Search SKY4444 data",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Platform V2 Search</h1>
        <p className="text-xs text-muted-foreground">AI-powered search · Find anything instantly · Voice search</p>
      </div>
