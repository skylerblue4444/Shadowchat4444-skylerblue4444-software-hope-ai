...
export default function ShadowCryptoResearch() {
  const items = [
    { icon: "📄", title: "Research Reports", desc: "Professional analyst reports", badge: "Deep" },
    { icon: "📊", title: "On-Chain", desc: "Whale moves supply demand", badge: "Data" },
    { icon: "🎯", title: "Price Targets", desc: "12-month price targets", badge: "Forecast" },
    { icon: "📈", title: "Technical", desc: "Chart patterns and indicators", badge: "Technical" },
    { icon: "💡", title: "Alpha", desc: "Early opportunities", badge: "Edge" },
    { icon: "✦", title: "SKY4444", desc: "SKY4444 research free", badge: "Perk" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Crypto Research Hub</h1>
        <p className="text-xs text-muted-foreground">Deep-dive reports · On-chain analysis · Price targets</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Institutional-grade crypto research.</p>
