...
export default function ShadowPlatformSDKV3() {
  ...
  const items=[{icon:"🟨",title:"JavaScript",desc:"Full JavaScript/TypeScript SDK",badge:"Web"},
    {icon:"🐍",title:"Python",desc:"Python SDK for data science",badge:"Data"},
    {icon:"🦀",title:"Rust",desc:"Rust SDK for performance",badge:"Fast"},
    {icon:"🐹",title:"Go",desc:"Go SDK for backend",badge:"Backend"},
    {icon:"📚",title:"Examples",desc:"100+ code examples",badge:"Learn"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 SDK integration",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">SDK V3 — Multi-Language</h1>
        <p className="text-xs text-muted-foreground">JavaScript Python Rust Go · Full SDK · Examples · Support</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Build with ShadowChat in any language.</p>
