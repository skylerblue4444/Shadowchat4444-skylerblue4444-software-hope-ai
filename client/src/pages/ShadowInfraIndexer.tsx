...
export default function ShadowInfraIndexer() {
  ...
  const items=[{icon:"📊",title:"Index Any Chain",desc:"Index any EVM chain",badge:"Universal"},
    {icon:"⚡",title:"Real-Time",desc:"Real-time block indexing",badge:"Live"},
    {icon:"🔍",title:"GraphQL",desc:"Powerful GraphQL queries",badge:"Flexible"},
    {icon:"📈",title:"Scale",desc:"Handles millions of queries",badge:"Scale"},
    {icon:"🔐",title:"Reliable",desc:"99.99% uptime SLA",badge:"Dependable"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 chain indexed",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Blockchain Indexer</h1>
        <p className="text-xs text-muted-foreground">Index any blockchain · GraphQL API · Real-time · Scalable</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Query any blockchain with ease.</p>
