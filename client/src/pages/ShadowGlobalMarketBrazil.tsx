...
export default function ShadowGlobalMarketBrazil() {
  ...
  const items=[{icon:"🇧🇷",title:"BRL Trading",desc:"Trade in Brazilian Real",badge:"Local"},
    {icon:"📱",title:"PIX",desc:"Instant payment system",badge:"Popular"},
    {icon:"⚖️",title:"CVM",desc:"Brazilian regulator compliant",badge:"Legal"},
    {icon:"📊",title:"Mercado Bitcoin",desc:"Brazil's top exchange",badge:"Reference"},
    {icon:"🌎",title:"Largest",desc:"Largest crypto market in LatAm",badge:"Scale"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 BRL pair",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Brazil Crypto Market</h1>
        <p className="text-xs text-muted-foreground">BRL trading · PIX payments · CVM compliance · Largest LatAm</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">The largest crypto market in Latin America.</p>
