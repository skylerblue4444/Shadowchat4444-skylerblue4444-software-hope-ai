...
export default function ShadowITGovt() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">FedRAMP and FISMA authorized IT solutions for federal, state, and local government agencies</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">FedRAMP Authorized</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-red-400">47</p><p className="text-xs text-muted-foreground">Agencies</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">Secret</p><p className="text-xs text-muted-foreground">Clearance</p></CardContent></Card>
