...
export default function ShadowPortfolioTracker() {
  const items = [
    { icon: "₿", title: "Bitcoin", desc: "0.00000847 BTC · $0.57", badge: "Live" },
          { icon: "🐕", title: "Dogecoin", desc: "4.444 DOGE · $0.82", badge: "Live" },
          { icon: "🇺🇸", title: "TRUMP", desc: "10.0 TRUMP · $142", badge: "Live" },
          { icon: "✦", title: "SKY4444", desc: "4,444 SKY4444 · $208", badge: "Live" },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Track all your crypto holdings · Live P&L · SKY4444 included</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Track your full portfolio. Live prices from CoinGecko. SKY4444 included.</p>
