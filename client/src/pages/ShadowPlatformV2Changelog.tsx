...
export default function ShadowPlatformV2Changelog() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"🚀",title:"Latest",desc:"Most recent platform updates",badge:"Fresh"},
    {icon:"✨",title:"Features",desc:"New feature releases",badge:"Exciting"},
    {icon:"🐛",title:"Bug Fixes",desc:"Issues we squashed",badge:"Quality"},
    {icon:"⚡",title:"Performance",desc:"Speed improvements",badge:"Fast"},
    {icon:"🔐",title:"Security",desc:"Security patches",badge:"Safe"},
    {icon:"📅",title:"History",desc:"Full changelog history",badge:"Complete"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Changelog</h1>
        <p className="text-xs text-muted-foreground">Every update every improvement every fix · Full history</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">See everything we've built and shipped.</p>
