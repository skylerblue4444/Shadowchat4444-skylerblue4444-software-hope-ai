...
export default function ShadowEnterpriseVPN() {
  const items = [
    { icon: "🛡️", title: "Zero-Trust", desc: "Never trust always verify", badge: "Modern" },
    { icon: "🌍", title: "Global", desc: "Servers in 50 countries", badge: "Fast" },
    { icon: "⚡", title: "Fast", desc: "No speed reduction", badge: "Performance" },
    { icon: "📱", title: "All Devices", desc: "Windows Mac iOS Android", badge: "Universal" },
    { icon: "📊", title: "Analytics", desc: "Network usage analytics", badge: "Visible" },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Zero-trust network · Remote access · Always-on security</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Secure your entire business network.</p>
