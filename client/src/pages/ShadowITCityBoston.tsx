...
export default function ShadowITCityBoston() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"📞",title:"Call Now",desc:"479-406-7123 Boston IT",badge:"Contact"},
    {icon:"💻",title:"Managed IT",desc:"Complete IT management",badge:"Full"},
    {icon:"🛡️",title:"Security",desc:"Cybersecurity for Boston",badge:"Safe"},
    ...
    <div className="space-y-4 pb-6">
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Boston's trusted IT partner.</p>
