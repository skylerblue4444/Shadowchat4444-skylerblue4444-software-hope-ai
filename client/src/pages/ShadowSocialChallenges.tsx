...
export default function ShadowSocialChallenges() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Participate in trading challenges, fitness goals, and creative contests with SKY4444 prizes</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Rise to the Top</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-yellow-400">8247</p><p className="text-xs text-muted-foreground">Active Challenges</p></CardContent></Card>
        ...
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">247</p><p className="text-xs text-muted-foreground">Winners/Day</p></CardContent></Card>
      </div>
