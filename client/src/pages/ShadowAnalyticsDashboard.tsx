...
export default function ShadowAnalyticsDashboard() {
  const items = [
    { icon: "📊", title: "Active Users", desc: "847 online right now", badge: "Live" },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Real-time platform metrics · Users · Revenue · Mining · Trading</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">View your complete analytics. Every metric tracked in real time.</p>
