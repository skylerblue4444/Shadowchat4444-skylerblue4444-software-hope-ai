...
export default function ShadowSocialV4Spaces() {
  ...
  const items=[{icon:"🎙️",title:"Live Audio",desc:"Real-time audio conversations",badge:"Live"},
    {icon:"💰",title:"Host Earn",desc:"Earn SKY4444 for hosting",badge:"Incentive"},
    {icon:"👥",title:"Listeners",desc:"Up to 10,000 listeners",badge:"Scale"},
    {icon:"🎤",title:"Speakers",desc:"Up to 10 speakers",badge:"Inclusive"},
    {icon:"📅",title:"Schedule",desc:"Schedule future spaces",badge:"Plan"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 tips for speakers",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Audio Spaces</h1>
        <p className="text-xs text-muted-foreground">Live audio rooms · Crypto discussions · Earn for hosting</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Host the crypto conversation.</p>
