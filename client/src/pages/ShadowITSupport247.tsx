...
export default function ShadowITSupport247() {
  const items = [
    { icon: "🕐", title: "24/7", desc: "Support every hour of every day", badge: "Always" },
    { icon: "⚡", title: "Fast Response", desc: "Under 15-minute response", badge: "Quick" },
    { icon: "🖥️", title: "Remote", desc: "Fix most issues remotely", badge: "Efficient" },
    { icon: "🚗", title: "On-Site", desc: "On-site for complex issues", badge: "Available" },
    { icon: "📊", title: "Ticket System", desc: "Track every issue", badge: "Organized" },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Round-the-clock IT support · Remote and on-site · Arkansas</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">IT support that never sleeps.</p>
