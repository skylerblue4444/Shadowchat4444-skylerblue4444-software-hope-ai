...
export default function ShadowCryptoCrossChainV2() {
  ...
  const items=[{icon:"🌉",title:"30+ Chains",desc:"Connect any chain to any chain",badge:"Universal"},
    {icon:"💰",title:"Best Rates",desc:"AI finds best cross-chain rate",badge:"Optimal"},
    {icon:"💬",title:"Messaging",desc:"Cross-chain message passing",badge:"Communicate"},
    {icon:"⚡",title:"Fast",desc:"Most bridges under 2 minutes",badge:"Quick"},
    {icon:"🛡️",title:"Secure",desc:"Audited bridge contracts",badge:"Safe"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 on every chain",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Cross-Chain Hub V2</h1>
        <p className="text-xs text-muted-foreground">Bridge swap message across 30+ chains · Best rates · Fast</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Move anything anywhere instantly.</p>
