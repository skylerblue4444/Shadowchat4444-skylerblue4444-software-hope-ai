...
export default function ShadowCryptoOptionsV2() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"📞",title:"Calls",desc:"Buy call options",badge:"Bullish"},
    {icon:"📉",title:"Puts",desc:"Buy put options",badge:"Bearish"},
    {icon:"📊",title:"Greeks",desc:"Delta gamma theta vega",badge:"Advanced"},
    {icon:"🔀",title:"Spreads",desc:"Bull bear spreads",badge:"Strategy"},
    {icon:"🏦",title:"Deribit",desc:"Deribit integration",badge:"Exchange"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 options market",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Crypto Options V2</h1>
        <p className="text-xs text-muted-foreground">Calls puts spreads · Deribit Lyra · Greeks · Strategies</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Professional options trading for crypto.</p>
