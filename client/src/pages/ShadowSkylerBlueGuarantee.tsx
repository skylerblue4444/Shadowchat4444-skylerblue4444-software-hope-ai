...
export default function ShadowSkylerBlueGuarantee() {
  ...
  const items=[{icon:"✅",title:"100% Satisfaction",desc:"Not happy? Full refund",badge:"Guaranteed"},
    {icon:"⏰",title:"SLA",desc:"Response time guaranteed",badge:"Committed"},
    {icon:"🔧",title:"Fix It Right",desc:"We fix it right the first time",badge:"Quality"},
    {icon:"💰",title:"Fair Pricing",desc:"Transparent no-surprise pricing",badge:"Honest"},
    {icon:"🤝",title:"Long-Term",desc:"We build long-term relationships",badge:"Partnership"},
    {icon:"📞",title:"Guarantee",desc:"479-406-7123",badge:"Backed"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Service Guarantee</h1>
        <p className="text-xs text-muted-foreground">100% satisfaction · Money back · SLA guaranteed · Arkansas</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">We stand behind every service we deliver.</p>
