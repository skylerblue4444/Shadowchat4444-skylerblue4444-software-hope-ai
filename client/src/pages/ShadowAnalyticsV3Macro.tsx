...
export default function ShadowAnalyticsV3Macro() {
  ...
  const items=[{icon:"🏦",title:"Fed Rates",desc:"Federal Reserve rate decisions",badge:"Macro"},
    {icon:"📈",title:"Inflation",desc:"CPI PPI inflation data",badge:"Economic"},
    {icon:"💵",title:"DXY",desc:"Dollar index correlation",badge:"Currency"},
    {icon:"🥇",title:"Gold",desc:"Gold vs Bitcoin correlation",badge:"Store of Value"},
    {icon:"📊",title:"Stocks",desc:"S&P 500 vs crypto correlation",badge:"Risk"},
  ...
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        ...
        <p className="text-xs text-muted-foreground">Fed rates · Inflation · DXY · Gold · Stocks vs crypto correlation</p>
      </div>
