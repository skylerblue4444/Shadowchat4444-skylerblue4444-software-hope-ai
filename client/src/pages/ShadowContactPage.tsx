...
export default function ShadowContactPage() {
  const items = [
    { icon: "📞", title: "Phone", desc: "479-406-7123 · 24/7", badge: "Call now" },
          { icon: "📧", title: "Email", desc: "skylerblue4444@gmail.com", badge: "Email" },
          { icon: "💬", title: "Live Chat", desc: "Chat on ShadowChat", badge: "Instant" },
          { icon: "🏠", title: "Address", desc: "Fayetteville, AR 72701", badge: "Visit" },
          { icon: "📱", title: "Text", desc: "SMS to 479-406-7123", badge: "Text" },
          { icon: "🌐", title: "GitHub", desc: "skylerblue4444", badge: "Open source" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Contact Us</h1>
        <p className="text-xs text-muted-foreground">Skyler Blue · 479-406-7123 · Fayetteville, Arkansas</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">We respond to every message. Usually within 1 hour.</p>
