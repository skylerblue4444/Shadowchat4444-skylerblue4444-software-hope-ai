...
export default function ShadowITQuantumCompute() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Access to quantum computing resources for optimization, cryptography, and AI acceleration</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Quantum Power</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-indigo-400">8247</p><p className="text-xs text-muted-foreground">Qubits Available</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">247</p><p className="text-xs text-muted-foreground">Algorithms</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">1M times faster</p><p className="text-xs text-muted-foreground">Speed vs Classical</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-orange-400">Cloud</p><p className="text-xs text-muted-foreground">Access</p></CardContent></Card>
      </div>
