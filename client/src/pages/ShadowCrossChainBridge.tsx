...
export default function ShadowCrossChainBridge() {
  const items = [
    { icon: "🌉", title: "20 Chains", desc: "Ethereum Solana Avalanche BNB +16", badge: "Complete" },
    { icon: "⚡", title: "Fast Bridge", desc: "Under 5 minutes", badge: "Quick" },
    { icon: "💰", title: "Low Fees", desc: "0.1% bridge fee", badge: "Cheap" },
    { icon: "🛡️", title: "Audited", desc: "Security-audited contracts", badge: "Safe" },
    { icon: "📊", title: "Track", desc: "Real-time bridge status", badge: "Transparent" },
    { icon: "✦", title: "SKY4444", desc: "Bridge SKY4444 to any chain", badge: "Native" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Cross-Chain Bridge</h1>
        <p className="text-xs text-muted-foreground">Move assets between 20 chains · BTC ETH SOL AVAX · SKY4444</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Move your crypto anywhere, instantly.</p>
