...
export default function ShadowWebSocket() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Real-time WebSocket API for live price feeds, order book updates, and notifications</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">WebSocket</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">8.4M</p><p className="text-xs text-muted-foreground">Connections</p></CardContent></Card>
      ...
      <div className="rounded-xl bg-gradient-to-br from-indigo-900/40 to-violet-900/40 border border-indigo-500/30 p-4">
        <p className="font-black text-sm mb-1">WebSocket API — Activate Now</p>
