...
export default function ShadowCryptoFearGreed() {
  const items = [
    { icon: "😱", title: "Extreme Fear", desc: "Buy opportunity signal", badge: "Contrarian" },
    { icon: "😰", title: "Fear", desc: "Cautious market sentiment", badge: "Careful" },
    { icon: "😐", title: "Neutral", desc: "Balanced market", badge: "Stable" },
    { icon: "😊", title: "Greed", desc: "Bullish market sentiment", badge: "Positive" },
    { icon: "🤑", title: "Extreme Greed", desc: "Potential sell signal", badge: "Caution" },
    { icon: "✦", title: "SKY4444", desc: "SKY4444 sentiment included", badge: "Native" }
  ];
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-black">Fear & Greed Index</h1>
        <p className="text-xs text-muted-foreground">Real-time crypto sentiment · Historical · Trading signals</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Know when to be greedy and when to be fearful.</p>
