...
export default function ShadowSKY4444V3Tokenomics() {
  ...
  const items=[{icon:"💰",title:"Total Supply",desc:"21 billion SKY4444 total supply",badge:"Scarce"},
    {icon:"🔥",title:"Burn",desc:"Quarterly burn mechanism",badge:"Deflationary"},
    {icon:"⏰",title:"Vesting",desc:"Team and investor vesting",badge:"Transparent"},
    {icon:"📊",title:"Distribution",desc:"Community 60% team 20% treasury 20%",badge:"Fair"},
    {icon:"📈",title:"Inflation",desc:"0% inflation post-launch",badge:"Fixed"},
    {icon:"✦",title:"SKY4444",desc:"Own a piece of SKY4444",badge:"Invest"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">SKY4444 V3 Tokenomics</h1>
        <p className="text-xs text-muted-foreground">Updated supply burn schedule vesting · V3 economy</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">The economics behind SKY4444 V3.</p>
