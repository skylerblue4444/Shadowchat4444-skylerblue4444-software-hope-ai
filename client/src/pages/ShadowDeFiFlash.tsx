...
export default function ShadowDeFiFlash() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        ...
        <Badge className="bg-indigo-600 text-white shrink-0">Zero Collateral</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-yellow-400">8247</p><p className="text-xs text-muted-foreground">Flash Loans/Day</p></CardContent></Card>
