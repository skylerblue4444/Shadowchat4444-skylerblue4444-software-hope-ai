...
export default function ShadowTermsOfService() {
  const items = [
    { icon: "📋", title: "Acceptance", desc: "By using ShadowChat you agree", badge: "Required" },
          { icon: "🛒", title: "Shop Terms", desc: "Purchase · Refund · Dispute", badge: "Commerce" },
          { icon: "⛏️", title: "Mining Terms", desc: "SKY4444 is experimental", badge: "Disclosure" },
          { icon: "🔐", title: "Privacy", desc: "We protect your data", badge: "Committed" },
          { icon: "⚖️", title: "Disputes", desc: "Arkansas law applies", badge: "Legal" },
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Last updated: 2025 · Read before using ShadowChat</p>
      </div>
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-4 px-4 text-center">
          ...
          <p className="text-xs text-muted-foreground mb-2">Full terms of service. Contact us with any questions.</p>
