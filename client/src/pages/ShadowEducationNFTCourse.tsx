...
export default function ShadowEducationNFTCourse() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"🎨",title:"Create NFTs",desc:"Mint your first NFT",badge:"Create"},
    {icon:"🛒",title:"Marketplace",desc:"Buy and sell NFTs",badge:"Trade"},
    {icon:"💰",title:"Royalties",desc:"Earn on every resale",badge:"Passive"},
    {icon:"🔍",title:"Research",desc:"Find valuable NFTs",badge:"Discover"},
    {icon:"🛡️",title:"Avoid Scams",desc:"Spot NFT scams",badge:"Safe"},
    {icon:"💰",title:"Earn",desc:"Earn SKY4444 for completing",badge:"Incentive"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">NFT Mastery Course</h1>
        <p className="text-xs text-muted-foreground">Create collect trade NFTs · Royalties · Marketplaces</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Master the NFT market.</p>
