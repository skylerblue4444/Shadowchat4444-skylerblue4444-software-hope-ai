...
export default function ShadowGameCryptoRacer() {
  const [a,sA]=useState<number|null>(null);
  const items=[{icon:"🏎️",title:"Race Cars",desc:"NFT car collection",badge:"Collect"},
    {icon:"🏆",title:"Tournaments",desc:"Weekly racing tournaments",badge:"Compete"},
    {icon:"💰",title:"Earn",desc:"Win SKY4444 prizes",badge:"Reward"},
    {icon:"🎨",title:"Customize",desc:"Customize your car NFT",badge:"Personal"},
    {icon:"🌍",title:"Global",desc:"Race players worldwide",badge:"Compete"},
    {icon:"✦",title:"SKY4444",desc:"All prizes in SKY4444",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Crypto Racer</h1>
        <p className="text-xs text-muted-foreground">Race to earn SKY4444 · NFT cars · Tournament prizes</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Race. Win. Earn SKY4444.</p>
