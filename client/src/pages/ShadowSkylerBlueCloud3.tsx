...
export default function ShadowSkylerBlueCloud3() {
    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Multi-cloud strategy and management across AWS, Azure, Google Cloud, and private cloud</p>
        </div>
        <Badge className="bg-indigo-600 text-white shrink-0">Best of All Clouds</Badge>
      </div>
      <div className="grid grid-cols-4 gap-2">
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-cyan-400">5+</p><p className="text-xs text-muted-foreground">Cloud Platforms</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-green-400">47pct avg</p><p className="text-xs text-muted-foreground">Cost Optimization</p></CardContent></Card>
        <Card className="border-border/50 text-center"><CardContent className="py-3 px-2"><p className="font-black text-lg text-blue-400">8247</p><p className="text-xs text-muted-foreground">Clients</p></CardContent></Card>
