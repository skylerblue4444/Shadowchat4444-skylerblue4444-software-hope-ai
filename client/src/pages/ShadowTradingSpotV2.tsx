...
export default function ShadowTradingSpotV2() {
  ...
  const items=[{icon:"📊",title:"Advanced Charts",desc:"TradingView-style charts",badge:"Professional"},
    {icon:"📋",title:"Order Types",desc:"Limit market stop OCO",badge:"Flexible"},
    {icon:"💧",title:"Deep Liquidity",desc:"Tight spreads deep books",badge:"Quality"},
    {icon:"⚡",title:"Fast Execution",desc:"Sub-millisecond execution",badge:"Speed"},
    {icon:"💰",title:"Low Fees",desc:"0.05% maker 0.1% taker",badge:"Cheap"},
    {icon:"✦",title:"SKY4444",desc:"SKY4444 spot trading",badge:"Native"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Spot Trading V2</h1>
        <p className="text-xs text-muted-foreground">Advanced spot trading · Limit market stop · All pairs</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Spot trading like a professional.</p>
