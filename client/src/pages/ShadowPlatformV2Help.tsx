...
export default function ShadowPlatformV2Help() {
  ...
  const items=[{icon:"🤖",title:"AI Help",desc:"Ask anything get instant answer",badge:"Smart"},
    {icon:"🎥",title:"Video Guides",desc:"Step-by-step video tutorials",badge:"Visual"},
    {icon:"💬",title:"Live Chat",desc:"Chat with support team",badge:"Human"},
    {icon:"📞",title:"Phone",desc:"479-406-7123 direct line",badge:"Personal"},
    {icon:"📚",title:"Knowledge Base",desc:"1000+ help articles",badge:"Comprehensive"},
    {icon:"✦",title:"SKY4444",desc:"Earn SKY4444 for feedback",badge:"Incentive"}];
  return (
    <div className="space-y-4 pb-6">
      <div className="border-b border-border/40 pb-3">
        <h1 className="text-2xl font-black">Help Center V2</h1>
        <p className="text-xs text-muted-foreground">AI-powered help · Video guides · Live chat · 479-406-7123</p>
      </div>
      ...
      <Card className="border-yellow-500/30 bg-gradient-to-br from-yellow-500/5 to-orange-500/5">
        <CardContent className="py-4 text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Help is always one tap away.</p>
